...
print("="*80)
print("回测：2020年4月24日 至 2026年6月3日")
print("="*80)
...
# 保存结果
portfolio_df.to_csv("回测结果_20200424_20260603_下穿买入20%.csv", index=False, encoding='utf-8-sig')
trade_df.to_csv("交易记录_20200424_20260603_下穿买入20%.csv", index=False, encoding='utf-8-sig')
